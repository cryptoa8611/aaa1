...
export const metadata = {
  title: "Lighting Design Course | DACES",
  description: "Enroll in our Lighting Design Course to master innovative lighting techniques for various applications. Learn from industry experts and enhance your skills in creating effective lighting solutions.",
  openGraph: {
    title: 'Lighting Design Course | DACES',
    description: 'Enroll in our Lighting Design Course to master innovative lighting techniques for various applications. Learn from industry experts and enhance your skills in creating effective lighting solutions.',
    url: 'https://dacescorp.com/en/training/lighting-design-course/',
    siteName: '',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/lighting-design-course/',
  },
  other: {
    'keywords': 'Lighting Design Course, Lighting Techniques, Lighting Design Training, Lighting Solutions, Interior Lighting Design, Outdoor Lighting Design',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "Lighting Design Course | DACES",
  "description": "Enroll in our Lighting Design Course to master innovative lighting techniques for various applications. Learn from industry experts and enhance your skills in creating effective lighting solutions.",
  "provider": {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Lighting Design Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>Lighting Design Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/lighting-design/lighting-design-course.jpg" 
                  alt="Lighting Design Course - Master Innovative Lighting Techniques by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h2 className="mb-5">Lighting Design Course: Discover the Future of Building Design</h2>
                  <h3>Introduction</h3>
                  <p>
                    Welcome to the Lighting Design Course – your gateway to exploring the world of building design and information management through Revit Architecture software. This is an opportunity to enhance your skills and knowledge in architectural design by leveraging advanced BIM technology.
                  </p>
