...
export const metadata = {
  title: "BIM for Asset/Facility Management | DACES",
  description: "DACES provides BIM for Asset/Facility Management services to help you optimize the operation and maintenance of your buildings. Our BIM solutions offer comprehensive data management, improve decision-making, and enhance the lifecycle performance of your assets.",
  openGraph: {
    title: 'BIM for Asset/Facility Management | DACES',
    description: 'DACES provides BIM for Asset/Facility Management services to help you optimize the operation and maintenance of your buildings. Our BIM solutions offer comprehensive data management, improve decision-making, and enhance the lifecycle performance of your assets.',
    url: 'https://dacescorp.com/en/bim-solutions/bim-for-asset-facility-management/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/bim-for-asset-facility-management.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/bim-for-asset-facility-management/',
  },
  other: {
    'keywords': 'BIM for Asset Management, BIM for Facility Management, Building Operations, BIM Solutions, Asset Lifecycle Management',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "BIM for Asset/Facility Management | DACES",
  "description": `DACES provides BIM for Asset/Facility Management services to help you optimize the operation and maintenance of your buildings. Our BIM solutions offer comprehensive data management, improve decision-making, and enhance the lifecycle performance of your assets.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/bim-for-asset-facility-management.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/bim-for-asset-facility-management/"
  ...
  "areaServed": "Vietnam",
  "serviceType": "BIM for Asset/Facility Management | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM for Asset/Facility Management</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>BIM for Asset/Facility Management</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>BIM for Asset/Facility Management:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. BIM for Asset/Facility Management sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/bim-for-asset-facility-management.jpg" 
                  alt="BIM Consultancy Services by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia BIM for Asset/Facility Management?</h4>
                  <ul>
                  ...
                  <p>BIM for Asset/Facility Management phù hợp với:
                  </p>
                  <ul>
