...
export const metadata = {
  title: "BIM Coordination - Seamless Project Collaboration | DACES",
  description: "DACES offers comprehensive BIM Coordination services to ensure seamless collaboration across all project stakeholders. Our BIM Coordination solutions help avoid clashes, optimize workflows, and enhance project efficiency from start to finish.",
  openGraph: {
    title: 'BIM Coordination - Seamless Project Collaboration | DACES',
    description: 'DACES offers comprehensive BIM Coordination services to ensure seamless collaboration across all project stakeholders. Our BIM Coordination solutions help avoid clashes, optimize workflows, and enhance project efficiency from start to finish.',
    url: 'https://dacescorp.com/en/bim-solutions/bim-coordination/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/bim-coordination.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/bim-coordination/',
  },
  other: {
...
const Schema = {
  ...
  "@type": "Service",
  "name": "BIM Coordination - Seamless Project Collaboration | DACES",
  "description": `DACES offers comprehensive BIM Coordination services to ensure seamless collaboration across all project stakeholders. Our BIM Coordination solutions help avoid clashes, optimize workflows, and enhance project efficiency from start to finish.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/bim-coordination.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/bim-coordination/"
  ...
  "areaServed": "Vietnam",
  "serviceType": "BIM Coordination - Seamless Project Collaboration | DACES",
};
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>BIM Coordination:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. BIM Coordination sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/bim-coordination.jpg" 
                  alt="BIM Consultancy Services by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia BIM Coordination?</h4>
                  <ul>
                  ...
                  <p>BIM Coordination phù hợp với:
                  </p>
                  <ul>
