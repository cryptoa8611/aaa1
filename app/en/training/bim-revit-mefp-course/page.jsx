...
export const metadata = {
  title: "BIM Revit MEFP Course | DACES",
  description: "Enhance your skills in Mechanical, Electrical, and Plumbing (MEFP) design with our BIM Revit MEFP course. Learn advanced techniques and improve your expertise with BIM technology.",
  openGraph: {
    title: 'BIM Revit MEFP Course | DACES',
    description: 'Enhance your skills in Mechanical, Electrical, and Plumbing (MEFP) design with our BIM Revit MEFP course. Learn advanced techniques and improve your expertise with BIM technology.',
    url: 'https://dacescorp.com/en/training/bim-revit-mefp-course/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/training/bim-revit-mefp/bim-revit-mefp-course.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/bim-revit-mefp-course/',
  },
  other: {
    'keywords': 'BIM Revit MEFP, Mechanical Electrical Plumbing BIM, MEFP Design Course, Revit MEFP Training, BIM MEFP Solutions',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "BIM Revit MEFP - Advanced Mechanical, Electrical, and Plumbing Design | DACES",
  "description": "Enhance your skills in Mechanical, Electrical, and Plumbing (MEFP) design with our BIM Revit MEFP course. Learn advanced techniques and improve your expertise with BIM technology.",
  "provider": {
...
export default function BimRevitMefp() {
  return (
    <div>
      <div>
        {/* Page Header Start */}
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM Revit MEFP Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>BIM Revit MEFP Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/bim-revit-mefp/bim-revit-mefp-course.jpg" 
                  alt="BIM Revit MEFP - Advanced Mechanical, Electrical, and Plumbing Design by DACES"
