...
export const metadata = {
  title: "Scan to BIM/As-built | DACES",
  description: "DACES offers Scan to BIM/As-built services, transforming laser scan data into precise 3D BIM models. Our expertise ensures accurate documentation for renovations, retrofits, and construction projects, streamlining your workflow and improving project outcomes.",
  openGraph: {
    title: 'Scan to BIM/As-built | DACES',
    description: 'DACES offers Scan to BIM/As-built services, transforming laser scan data into precise 3D BIM models. Our expertise ensures accurate documentation for renovations, retrofits, and construction projects, streamlining your workflow and improving project outcomes.',
    url: 'hhttps://dacescorp.com/en/bim-solutions/scan-to-bim/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/scan-to-bim.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/scan-to-bim/',
  },
  other: {
    'keywords': 'Scan to BIM/As-built, Point Cloud to BIM, 3D BIM Models, Laser Scanning, Construction Documentation',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "Scan to BIM/As-built | DACES",
  "description": `DACES offers Scan to BIM/As-built services, transforming laser scan data into precise 3D BIM models. Our expertise ensures accurate documentation for renovations, retrofits, and construction projects, streamlining your workflow and improving project outcomes.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/scan-to-bim.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/scan-to-bim/"
  },
  "areaServed": "Vietnam",
  "serviceType": "Scan to BIM/As-built | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Scan to BIM/As-built</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>Scan to BIM/As-built</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>Scan to BIM/As-built:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. Scan to BIM/As-built sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/scan-to-bim.jpg" 
                  alt="Scan to BIM/As-built by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia Scan to BIM/As-built?</h4>
                  <ul>
                  ...
                  <p>Scan to BIM/As-built phù hợp với:
                  </p>
                  <ul>
