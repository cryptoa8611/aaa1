...
export const metadata = {
  ...
  title: "BIM Automation - Optimize Design & Construction | DACES",
  description: "DACES offers BIM Automation services to streamline your design and construction processes. Our solutions automate repetitive tasks, enhance project efficiency, and improve collaboration through advanced BIM technologies, ensuring faster and more accurate project delivery.",
  openGraph: {
    title: 'BIM Automation - Optimize Design & Construction | DACES',
    description: 'DACES offers BIM Automation services to streamline your design and construction processes. Our solutions automate repetitive tasks, enhance project efficiency, and improve collaboration through advanced BIM technologies, ensuring faster and more accurate project delivery.',
    url: 'https://dacescorp.com/en/bim-solutions/bim-automation/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/bim-automation.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/bim-automation/',
  },
  other: {
    'keywords': 'BIM Automation, Automated BIM Processes, BIM Automation Tools, Construction Automation, BIM Efficiency, Project Management',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "BIM Automation - Optimize Design & Construction | DACES",
  "description": `DACES offers BIM Automation services to streamline your design and construction processes. Our solutions automate repetitive tasks, enhance project efficiency, and improve collaboration through advanced BIM technologies, ensuring faster and more accurate project delivery.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/bim-automation.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/bim-automation/"
  ...
  "areaServed": "Vietnam",
  "serviceType": "BIM Automation - Optimize Design & Construction | DACES",
};
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>BIM Automation:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. BIM Automation sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/bim-automation.jpg" 
                  alt="BIM Automation - Optimize Design & Construction by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia BIM Automation?</h4>
                  <ul>
