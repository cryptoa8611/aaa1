...
export const metadata = {
  title: "Expert Structural Engineering Services | DACES",
  description:
    "DACES provides top-notch Structure Design Consulting with expertise in structural engineering, building design, and structural analysis. Our consultants deliver innovative and reliable structural solutions for residential and commercial projects.",
  openGraph: {
    title: "Expert Structural Engineering Services | DACES",
    description:
      "DACES provides top-notch Structure Design Consulting with expertise in structural engineering, building design, and structural analysis. Our consultants deliver innovative and reliable structural solutions for residential and commercial projects.",
    ...
    images: [
      {
        url:
          "https://dacescorp.com/en/assets/img/design-consultancy/structure-design-consulting.jpg", // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
...
const Schema = {
  ...
  "@type": "Service",
  "name": "Expert Structural Engineering Services | DACES",
  "description": `DACES provides top-notch Structure Design Consulting with expertise in structural engineering, building design, and structural analysis. Our consultants deliver innovative and reliable structural solutions for residential and commercial projects.`,
  ...
  "areaServed": "Vietnam",
  "serviceType": "Expert Structural Engineering Services | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Structure Design Consulting</h2>
              </div>
              <div className="col-12">
                <Link href="/vi/">Home</Link>
                <Link href="">Structure Design Consulting</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h3>
                    Structure Design Consulting: Transform Your
                  ...
                  <Image
                    src="/assets/img/design-consultancy/structure-design-consulting.jpg"
                    alt="Structure Design Consulting - Expert Structural Engineering Services"
                    width={3840} // Chiều rộng gốc của ảnh
                    height={2000} // Chiều cao gốc của ảnh
                    layout="responsive"
                  />
                  <h4>
                    Why Choose Our Structure Design Consulting
                    Services?
                  </h4>
                  <ul>
                    <li>
