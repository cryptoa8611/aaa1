...
export const metadata = {
  title: "Civil and Infrastructure Design Course | DACES",
  description: "Enroll in our Civil and Infrastructure Design Course to master the latest engineering techniques in civil and infrastructure design. Gain expertise from industry professionals and advance your career with comprehensive training.",
  openGraph: {
    title: 'Civil and Infrastructure Design Course | DACES',
    description: 'Enroll in our Civil and Infrastructure Design Course to master the latest engineering techniques in civil and infrastructure design. Gain expertise from industry professionals and advance your career with comprehensive training.',
    url: 'https://dacescorp.com/en/training/civil-and-infrastructure-design-course/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/training/civil-and-infrastructure-design/civil-and-infrastructure-design-course.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/civil-and-infrastructure-design-course/',
  },
  other: {
    'keywords': 'Civil Design Course, Infrastructure Design Course, Engineering Course, Civil Engineering Training, Infrastructure Engineering',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "Civil and Infrastructure Design Course | DACES",
  "description": "Enroll in our Civil and Infrastructure Design Course to master the latest engineering techniques in civil and infrastructure design. Gain expertise from industry professionals and advance your career with comprehensive training.",
  "provider": {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Civil and Infrastructure Design Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>Civil and Infrastructure Design Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/civil-and-infrastructure-design/civil-and-infrastructure-design-course.jpg" 
                  alt="Civil and Infrastructure Design Course by DACES"
