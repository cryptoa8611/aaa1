...
export const metadata = {
  title: "3D/BIM Modeling - Precise and Efficient BIM Solutions | DACES",
  ...
  other: {
    'keywords': '3D Modeling, BIM Modeling, 3D BIM Services, BIM Solutions, Building Information Modeling',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "3D/BIM Modeling - Precise and Efficient BIM Solutions | DACES",
  "description": `DACES offers expert 3D/BIM Modeling services, delivering accurate and efficient models to enhance your project planning and execution. Our BIM solutions ensure seamless coordination and optimized workflows for construction projects.`,
  "image": "https://dacescorp.com/en//assets/img/bim-solutions/3d-bim-modeling.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/3d-bim-modeling/"
  ...
  "areaServed": "Vietnam",
  "serviceType": "3D/BIM Modeling - Precise and Efficient BIM Solutions | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>3D/BIM Modeling</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>3D/BIM Modeling</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>3D/BIM Modeling:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. 3D/BIM Modeling sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/3d-bim-modeling.jpg" 
                  alt="3D/BIM Modeling by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia 3D/BIM Modeling?</h4>
                  <ul>
