...
export const metadata = {
  title: "3D/Laser Scanning Survey | DACES",
  description: "DACES offers 3D/Laser Scanning Survey services, providing highly accurate and detailed spatial data for your projects. Our advanced laser scanning technology captures precise measurements and creates comprehensive 3D models, ensuring the success of your construction, renovation, or asset management projects.",
  openGraph: {
    title: '3D/Laser Scanning Survey | DACES',
    description: 'DACES offers 3D/Laser Scanning Survey services, providing highly accurate and detailed spatial data for your projects. Our advanced laser scanning technology captures precise measurements and creates comprehensive 3D models, ensuring the success of your construction, renovation, or asset management projects.',
    url: 'https://dacescorp.com/en/bim-solutions/3d-laser-scannning-survey/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/3d-laser-scanning-survey.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/3d-laser-scanning-survey/',
  },
  other: {
    'keywords': 'BIM Consultancy Services, BIM Solutions, Building Information Modeling, BIM Coordination, BIM Management',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "3D/Laser Scanning Survey | DACES",
  "description": `DACES offers 3D/Laser Scanning Survey services, providing highly accurate and detailed spatial data for your projects. Our advanced laser scanning technology captures precise measurements and creates comprehensive 3D models, ensuring the success of your construction, renovation, or asset management projects.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/3d-laser-scanning-survey.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/3d-laser-scanning-survey/"
  },
  "areaServed": "Vietnam",
  "serviceType": "3D/Laser Scanning Survey | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>3D/Laser Scanning Survey</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>3D/Laser Scanning Survey</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>3D/Laser Scanning Survey:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <h4>Giới thiệu khóa học</h4>
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. 3D/Laser Scanning Survey sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <Image
                  src="/assets/img/bim-solutions/3d-laser-scanning-survey.jpg" 
                  alt="3D/Laser Scanning Survey by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia 3D/Laser Scanning Survey?</h4>
                  <ul>
                  ...
                  <p>3D/Laser Scanning Survey phù hợp với:
                  </p>
                  <ul>
