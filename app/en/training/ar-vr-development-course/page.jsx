...
export const metadata = {
  title: "AR/VR Development Course for BIM | DACES",
  description: "Join our AR/VR Development Course designed for BIM professionals. Learn cutting-edge augmented and virtual reality techniques to enhance your Building Information Modeling projects. Enroll today to boost your skills and stay ahead in the industry. Enroll now!",
  openGraph: {
    title: 'AR/VR Development Course for BIM | DACES',
    description: 'Join our AR/VR Development Course designed for BIM professionals. Learn cutting-edge augmented and virtual reality techniques to enhance your Building Information Modeling projects. Enroll today to boost your skills and stay ahead in the industry. Enroll now!',
    url: 'https://dacescorp.com/en/training/ar-vr-development-course/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/training/ar-vr-development/ar-vr-development-course.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/ar-vr-development-course/',
  },
  other: {
    'keywords': 'BIM Revit Structure, Structural Design Course, BIM Technology, Revit Structure Training, Structural Engineering',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "AR/VR Development Course for BIM | DACES",
  "description": "Join our AR/VR Development Course designed for BIM professionals. Learn cutting-edge augmented and virtual reality techniques to enhance your Building Information Modeling projects. Enroll today to boost your skills and stay ahead in the industry. Enroll now!",
  "provider": {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>AR/VR Development Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>AR/VR Development Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/ar-vr-development/ar-vr-development-course.jpg" 
                  alt="AR/VR Development Course by DACES"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h2 className="mb-5">AR/VR Development Course: Discover the Future of Building Design</h2>
                  <h3>Introduction</h3>
                  <p>
                    Welcome to the AR/VR Development Course – your gateway to exploring the world of building design and information management through Revit Architecture software. This is an opportunity to enhance your skills and knowledge in architectural design by leveraging advanced BIM technology.
                  </p>
