...
export const metadata = {
  title: "Revit API and Dynamo Course | DACES",
  description: "Enroll in our Revit API and Dynamo Course to master the customization and automation of Revit using Revit API and Dynamo. Learn advanced techniques to enhance your BIM workflows and improve efficiency. Sign up today to elevate your skills in Revit development.",
  openGraph: {
    title: 'Revit API and Dynamo Course | DACES',
    description: 'Enroll in our Revit API and Dynamo Course to master the customization and automation of Revit using Revit API and Dynamo. Learn advanced techniques to enhance your BIM workflows and improve efficiency. Sign up today to elevate your skills in Revit development.',
    url: 'https://dacescorp.com/en/training/revit-api-and-dynamo-course/',
    siteName: '',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/revit-api-and-dynamo-course/',
  },
  other: {
    'keywords': 'Revit API Course, Dynamo Course, Revit Customization, BIM Automation, Revit Development, Dynamo for Revit, Revit API and Dynamo',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "Revit API and Dynamo Course | DACES",
  "description": "Enroll in our Revit API and Dynamo Course to master the customization and automation of Revit using Revit API and Dynamo. Learn advanced techniques to enhance your BIM workflows and improve efficiency. Sign up today to elevate your skills in Revit development.",
  "provider": {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM Revit Structure Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>BIM Revit Structure Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h3 className="mb-5">BIM Revit Structure Course: Discover the Future of Building Design</h3>
                  <p>
                  ...
                  <Image
                  src="/assets/img/training/revit-api-and-dynamo/revit-api-and-dynamo-course.jpg" 
                  alt="Revit API and Dynamo Course - Master Revit Customization and Automation by DACES"
