...
export const metadata = {
  title: "BIM/GIS Course - Enhance Your Skills in BIM and GIS | DACES",
  description: "Enroll in our BIM/GIS Course to gain comprehensive skills in Building Information Modeling (BIM) and Geographic Information Systems (GIS). Learn from industry experts and advance your career with cutting-edge technologies.",
  openGraph: {
    title: 'BIM/GIS Course - Enhance Your Skills in BIM and GIS | DACES',
    description: 'Enroll in our BIM/GIS Course to gain comprehensive skills in Building Information Modeling (BIM) and Geographic Information Systems (GIS). Learn from industry experts and advance your career with cutting-edge technologies.',
    url: 'https://dacescorp.com/en/training/bim-gis-course/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/training/bim-gis/bim-gis-course.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/bim-gis-course/',
  },
  other: {
    'keywords': 'BIM GIS Course, BIM and GIS Training, BIM GIS Skills, GIS and BIM Course, BIM and GIS Solutions',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "BIM/GIS Course - Enhance Your Skills in BIM and GIS | DACES",
  "description": "Enroll in our BIM/GIS Course to gain comprehensive skills in Building Information Modeling (BIM) and Geographic Information Systems (GIS). Learn from industry experts and advance your career with cutting-edge technologies.",
  "provider": {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM/GIS Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>BIM/GIS Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/bim-gis/bim-gis-course.jpg" 
