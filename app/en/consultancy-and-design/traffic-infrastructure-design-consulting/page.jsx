...
export const metadata = {
  title: "Expert Traffic Infrastructure Design Consulting Services | DACES",
  description:
    "DACES provides top-notch Traffic Infrastructure Design Consulting with expertise in structural engineering, building design, and structural analysis. Our consultants deliver innovative and reliable structural solutions for residential and commercial projects.",
  openGraph: {
    title: "Expert Traffic Infrastructure Design Consulting Services | DACES",
    description:
      "DACES provides top-notch Traffic Infrastructure Design Consulting with expertise in structural engineering, building design, and structural analysis. Our consultants deliver innovative and reliable structural solutions for residential and commercial projects.",
  ...
  other: {
    keywords:
      "Traffic InfraTraffic Infrastructure Design Consulting, Traffic Management Solutions, Transportation Infrastructure Design, Traffic Engineering Services, Infrastructure Development Consulting",
  },
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Traffic Infrastructure Design Consulting</h2>
              </div>
              <div className="col-12">
                <Link href="/vi/">Home</Link>
                <Link href="">Traffic Infrastructure Design Consulting</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h3>
                    Traffic Infrastructure Design Consulting: Transform Your
                  ...
                  <Image
                    src="/assets/img/design-consultancy/traffic-infrastructure-design-consulting.jpg"
                    alt="Traffic Infrastructure Design Consulting - Expert Structural Engineering Services"
                    width={3840} // Chiều rộng gốc của ảnh
                    height={2000} // Chiều cao gốc của ảnh
                    layout="responsive"
                  />
                  <h4>
                    Why Choose Our Traffic Infrastructure Design Consulting
                    Services?
                  </h4>
                  <ul>
                    <li>
