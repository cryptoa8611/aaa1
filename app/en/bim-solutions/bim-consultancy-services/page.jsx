...
export const metadata = {
  title: "BIM Consultancy Services | DACES",
  description: "DACES provides comprehensive BIM Consultancy Services, offering expert solutions to optimize your building projects with the latest BIM technology. We deliver efficient and precise BIM modeling, coordination, and management services.",
  openGraph: {
    title: 'BIM Consultancy Services | DACES',
    description: 'DACES provides comprehensive BIM Consultancy Services, offering expert solutions to optimize your building projects with the latest BIM technology. We deliver efficient and precise BIM modeling, coordination, and management services.',
    ...
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/bim-consultancy-services.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/bim-consultancy-services/',
  },
  other: {
...
const Schema = {
  ...
  "@type": "Service",
  "name": "BIM Consultancy Services | DACES",
  "description": `DACES provides comprehensive BIM Consultancy Services, offering expert solutions to optimize your building projects with the latest BIM technology. We deliver efficient and precise BIM modeling, coordination, and management services.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/bim-consultancy-services.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/bim-consultancy-services/"
  },
  "areaServed": "Vietnam",
  "serviceType": "BIM Consultancy Services | DACES",
};


export default function BimConsultancyServices() {
  return (
    <div>
      <div>
        {/* Page Header Start */}
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM Consultancy Servcies</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>BIM Consultancy Servcies</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>BIM Consultancy Servcies:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <Image
                  src="/assets/img/bim-solutions/bim-consultancy-services.jpg" 
                  ...
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. BIM Consultancy Servcies sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <h4>Tại sao nên tham gia BIM Consultancy Servcies?</h4>
                  <ul>
                  ...
                  <p>BIM Consultancy Servcies phù hợp với:
                  </p>
                  <ul>
