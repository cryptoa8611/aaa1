...
export const metadata = {
  title: "BIM Manager Course - Advance Your Skills in BIM Management | DACES",
  description: "Join our BIM Manager Course to develop advanced skills in BIM management. Learn from industry experts and enhance your capabilities in managing BIM projects effectively.",
  openGraph: {
    title: 'BIM Manager Course - Advance Your Skills in BIM Management | DACES',
    description: 'Join our BIM Manager Course to develop advanced skills in BIM management. Learn from industry experts and enhance your capabilities in managing BIM projects effectively.',
    url: 'https://dacescorp.com/en/training/bim-manager-course/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/training/bim-manager/bim-manager-course.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/bim-manager-course/',
  },
  other: {
    'keywords': 'BIM Manager Course, BIM Management Training, BIM Leadership, BIM Course, BIM Project Management',
  },
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM Manager Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>BIM Manager Course</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/bim-manager/bim-manager-course.jpg" 
                  alt="BIM Manager Course - Advance Your Skills in BIM Management by DACES"
