...
export const metadata = {
  ...
  title: "BIM 4D Construction Simulation - Advanced Project Planning | DACES",
  description: "DACES offers BIM 4D Construction Simulation services, integrating time-based data into 3D models for advanced project planning and management. Our solutions provide detailed visualization of construction timelines, helping you manage resources, optimize scheduling, and ensure project success.",
  openGraph: {
    title: 'BIM 4D Construction Simulation - Advanced Project Planning | DACES',
    description: 'DACES offers BIM 4D Construction Simulation services, integrating time-based data into 3D models for advanced project planning and management. Our solutions provide detailed visualization of construction timelines, helping you manage resources, optimize scheduling, and ensure project success.',
    url: 'https://dacescorp.com/en/bim-solutions/bim-4D-construction-simulation/',
    siteName: '',
    images: [
      {
        url: 'https://dacescorp.com/assets/img/bim-solutions/bim-4d-construction-simulation.jpg', // Must be an absolute URL
        width: 800,
        height: 600,
      },
    ],
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/bim-solutions/bim-4D-construction-simulation/',
  },
  other: {
    'keywords': 'BIM 4D Simulation, Construction Simulation, 4D BIM, Project Planning, Construction Management, Time-Based Modeling',
  },
};
...
const Schema = {
  ...
  "@type": "Service",
  "name": "BIM 4D Construction Simulation - Advanced Project Planning | DACES",
  "description": `DACES offers BIM 4D Construction Simulation services, integrating time-based data into 3D models for advanced project planning and management. Our solutions provide detailed visualization of construction timelines, helping you manage resources, optimize scheduling, and ensure project success.`,
  "image": "https://dacescorp.com/assets/img/bim-solutions/bim-4d-construction-simulation.jpg",
  "provider": {
    "@type": "Organization",
    "name": "DACES",
    "url": "https://dacescorp.com/en/bim-solutions/bim-4D-construction-simulation/"
  ...
  "areaServed": "Vietnam",
  "serviceType": "BIM 4D Construction Simulation - Advanced Project Planning | DACES",
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM 4D Construction Simulation</h2>
              </div>
              <div className="col-12">
                <Link href="/en/">Home</Link>
                <a href>BIM 4D Construction Simulation</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2><span>BIM 4D Construction Simulation:</span> Nâng cao kỹ năng thiết kế Kiến Trúc với Công nghệ hiện đại</h2>
                  <Image
                  src="/assets/img/bim-solutions/bim-4d-construction-simulation.jpg" 
                  alt="BIM 4D Construction Simulation - Advanced Project Planning by DACES"
                  ...
                  <p>
                    Trong thế giới kiến trúc hiện đại, việc nắm vững công nghệ và các công cụ thiết kế tiên tiến là điều cần thiết. BIM 4D Construction Simulation sẽ trang bị cho bạn những kỹ năng cần thiết để sử dụng phần mềm Revit Architecture một cách hiệu quả, từ đó nâng cao chất lượng và hiệu quả của các dự án kiến trúc.
                  </p>
                  <h4>Tại sao nên tham gia BIM 4D Construction Simulation?</h4>
                  <ul>
                  ...
                  <p>BIM 4D Construction Simulation phù hợp với:
                  </p>
                  <ul>
