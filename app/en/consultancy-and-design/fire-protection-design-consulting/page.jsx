...
export const metadata = {
  title: "Fire Protection Design Consulting | DACES",
  description:
    "DACES offers comprehensive Fire Protection Design Consulting, specializing in Mechanical, Electrical, and Plumbing design solutions. Our experts provide innovative and efficient systems for building projects to meet your specific needs.",
  openGraph: {
    title: "Fire Protection Design Consulting | DACES",
    description:
      "DACES offers comprehensive Fire Protection Design Consulting, specializing in Mechanical, Electrical, and Plumbing design solutions. Our experts provide innovative and efficient systems for building projects to meet your specific needs.",
  ...
  other: {
    keywords:
      "Fire Protection Design Consulting, Fire Safety Design Services, Fire Protection System Design, Fire Protection Engineering Consulting, Building Fire Protection Solutions",
  },
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Fire Protection Design Consulting</h2>
              </div>
              <div className="col-12">
                <Link href="/vi/">Home</Link>
                <Link href="">Fire Protection Design Consulting</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h3>
                    Fire Protection Design Consulting: Transform Your
                  ...
                  <Image
                    src="/assets/img/design-consultancy/fire-protection-design-consulting.jpg"
                    alt="Expert Fire Protection Design Consulting Services"
                    width={3840} // Chiều rộng gốc của ảnh
                    height={2000} // Chiều cao gốc của ảnh
                    layout="responsive"
                  />
                  <h4>
                    Why Choose Our Fire Protection Design Consulting
                    Services?
                  </h4>
                  <ul>
                    <li>
