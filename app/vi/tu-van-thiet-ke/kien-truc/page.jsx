...
export const metadata = {
  title: "Tư vấn thiết kế kiến trúc - DACES",
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "Tư vấn thiết kế kiến trúc - DACES",
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>Tư vấn thiết kế kiến trúc</h2>
              </div>
              <div className="col-12">
                <Link href="/vi/">Trang chủ</Link>
                <Link href="">Tư vấn thiết kế kiến trúc</Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <h2>Dịch Vụ Tư Vấn Thiết Kế Kiến Trúc Áp Dụng BIM: Tạo Nên Tương Lai Xây Dựng Thông Minh</h2>
                  <p>
                    Trong ngành xây dựng hiện đại, công nghệ Building Information Modeling (BIM) đã trở thành một công cụ thiết yếu, mang lại sự thay đổi toàn diện trong cách tiếp cận và quản lý các dự án kiến trúc. Dịch vụ tư vấn thiết kế kiến trúc áp dụng BIM không chỉ là một xu hướng, mà còn là một giải pháp tối ưu hóa toàn bộ quy trình từ khâu thiết kế đến triển khai và vận hành công trình.
                  </p>
                  <Image
                  src="/assets/img/training/revit-architecture/bim-revit-architecture-2024.jpg" 
                  alt="Tư vấn thiết kế kiến trúc - Nâng cao khả năng thiết kế"
                  width={3840}   // Chiều rộng gốc của ảnh
                  height={2000}   // Chiều cao gốc của ảnh
                  layout="responsive"
                  />
                  <h4>Tại sao nên tham gia Tư vấn thiết kế kiến trúc?</h4>
                  <ul>
                  ...
                  <p>Tư vấn thiết kế kiến trúc phù hợp với:
                  </p>
                  <ul>
