...
export const metadata = {
  title: "BIM 4D Construction Simulation Course | DACES",
  description: "Join our BIM Revit Structure course to enhance your structural design skills using advanced BIM technology. Learn from experts and elevate your career in structural engineering. Enroll now!",
  openGraph: {
    title: 'BIM Revit Structure Course | DACES',
    description: 'Join our BIM Revit Structure course to enhance your structural design skills using advanced BIM technology. Learn from experts and elevate your career in structural engineering. Enroll now!',
    url: 'https://dacescorp.com/en/training/4d-construction-annimation-course/',
    siteName: '',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/4d-construction-annimation-course/',
  },
  other: {
    'keywords': 'BIM 4D Construction Simulation Course, 4D BIM, Construction Simulation, Building Information Modeling, BIM Training, Construction Management, BIM 4D Techniques',
  },
};
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "BIM 4D Construction Simulation Course | DACES",
  "description": "Join our BIM Revit Structure course to enhance your structural design skills using advanced BIM technology. Learn from experts and elevate your career in structural engineering. Enroll now!",
  "provider": {
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  <Image
                  src="/assets/img/training/bim-revit-structure/bim-revit-structure-course.jpg" 
                  alt="BIM 4D Construction Simulation Course by DACES"
