...
export const metadata = {
  title: "BIM Revit Architecture Course | DACES",
  description: "Join our BIM Revit Architecture Course to gain advanced skills in architectural design using Revit. Enroll with DACES for expert training and hands-on experience.",
  openGraph: {
    title: 'BIM Revit Architecture Course | DACES',
    description: 'Join our BIM Revit Architecture Course to gain advanced skills in architectural design using Revit. Enroll with DACES for expert training and hands-on experience.',
    url: 'https://daces.com/en/',
    siteName: '',
    images: [
      {
  ...
  other: {
    'keywords': 'BIM Revit Architecture Course, Revit Architecture Training, BIM Architecture Classes, Advanced BIM Revit Course, Professional Revit Architecture Training',
  },
};
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2>BIM Revit Architecture Course</h2>
              </div>
              <div className="col-12">
                <a href>Home</a>
                <a href>BIM Revit Architecture Course</a>
              </div>
            </div>
          </div>
        </div>
