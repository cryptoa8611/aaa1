...
export const metadata = {
  ...
  openGraph: {
    title: 'BIM Revit Structure Course | DACES',
    description: 'Join our BIM Revit Structure course to enhance your structural design skills using advanced BIM technology. Learn from experts and elevate your career in structural engineering. Enroll now!',
    url: 'https://dacescorp.com/en/training/bim-revit-structure-course/',
    siteName: '',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://dacescorp.com/en/training/bim-revit-structure-course/',
  },
  other: {
...
const Schema =    {
  ...
  "@type": "Course",
  "name": "BIM Revit Structure Course | DACES",
  "description": "Join our BIM Revit Structure course to enhance your structural design skills using advanced BIM technology. Learn from experts and elevate your career in structural engineering. Enroll now!",
  "provider": {
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="single-content wow fadeInUp">
                  ...
                  alt="BIM Revit Structure Course by DACES"
